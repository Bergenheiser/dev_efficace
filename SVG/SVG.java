...
public class SVG extends Tag {
    ...
    private double width;       //Largeur de l'image
    private double height;      //Hauteur de l'image
    private final List<Tag2> content;  //Liste d'éléments contenus dans la balise SVG
